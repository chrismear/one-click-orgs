...
ActiveRecord::Schema.define(version: 20140112175011) do
  ...
  add_index "clauses", ["organisation_id"], name: "index_clauses_on_organisation_id", using: :btree
  ...
  add_index "decisions", ["proposal_id"], name: "index_decisions_on_proposal_id", using: :btree
  ...
  add_index "member_classes", ["organisation_id"], name: "index_member_classes_on_organisation_id", using: :btree
  ...
  add_index "members", ["organisation_id"], name: "index_members_on_organisation_id", using: :btree
  ...
  add_index "seen_notifications", ["member_id", "notification"], name: "index_seen_notifications_on_member_id_and_notification", using: :btree
  add_index "seen_notifications", ["member_id"], name: "index_seen_notifications_on_member_id", using: :btree
  ...
  add_index "votes", ["proposal_id", "member_id"], name: "index_votes_on_proposal_id_and_member_id", using: :btree
