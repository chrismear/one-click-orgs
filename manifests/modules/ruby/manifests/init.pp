class ruby {
  ...
  exec {'build_ruby':
    command => '/usr/local/bin/ruby-build 1.9.2-p290 /home/vagrant/.rbenv/versions/1.9.2-p290',
    creates => '/home/vagrant/.rbenv/versions/1.9.2-p290/bin/ruby',
  ...
  exec {'update_rubygems':
    command => '/home/vagrant/.rbenv/versions/1.9.2-p290/bin/gem update --system',
